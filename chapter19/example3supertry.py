...
def processop(op, q, s):
    ...
    if(op == ")"):
        ...
        while(sempty(s) == 0):
            ...
            while(qempty(q) == 0):
                q, tptr[g] = qpop(q)
                print("Q popping  150" + str(tptr[g]))
                g = g + 1
            s, tptr[g] = spop(s)
            print("S popping 153 " + tptr[g])
            g = g + 1
        print("S pushing....")
        s = spush(s, op)
    return q, s
